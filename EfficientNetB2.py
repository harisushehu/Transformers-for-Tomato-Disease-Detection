...
transform = transforms.Compose([
    transforms.Resize((260, 260)),  # EfficientNetB2 expects 260x260 input
...
model = models.efficientnet_b2(pretrained=False, num_classes=len(dataset.classes)).to(device)
...
# Evaluation
model.load_state_dict(torch.load('efficientnetb2_best.pth'))
model.eval()
test_corrects = 0
test_total = 0
all_preds = []
...
results_df.to_csv('EfficientNetB2_result.csv', index=False)
